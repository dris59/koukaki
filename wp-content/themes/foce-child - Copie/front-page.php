...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <video class="banner__video" width="1440" autoplay="autoplay" muted=""
            ...
            <img class="banner__logo"  data-aos="fade-up"  src="<?php echo get_template_directory_uri() . '/assets/images/logo.png'; ?> " alt="logo Fleurs d'oranger & chats errants">
        </section>
  ...
  <div class="main-character">
     ...
     data-aos-duration="3000">
        ...
        <section id="studio"  data-aos="fade-up"  data-aos-duration="3000">
            ...
            <section  class="nom-osca"  data-aos="fade-down"
